README for building on Mac OS X
----
...
implementatation; some experimentation to determine optimal ones
...
step 2 before the others, and if continuing from where you left off,
...
optional but allows "man mpiexec" etc to work:
