...
float* GetInnerSimMatrix(int row, int col, int nSubs, int nTrials, Trial* trials, RawMatrix** r_matrices1, RawMatrix** r_matrices2);
float* GetPartialInnerSimMatrix(int row, int col, int nSubs, int nTrials, int sr, int rowLength, Trial* trials, RawMatrix** r_matrices1, RawMatrix** r_matrices2);
